    ...
    <>
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${navBg}`}>
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between gap-6 px-4 sm:px-6 lg:px-8">
          ...
          {/* Logo — left */}
          <Link href="/" aria-label="Kafui Dey — Home" className="shrink-0">
            <Image
              src="/logo.png"
              alt="Kafui Dey"
              width={800}
          ...
          {/* YouTube button — far right (desktop) */}
          ...
          <div className="flex md:hidden">
            ...
            >
              ...
              <span className={`mt-[5px] block h-0.5 w-6 rounded-full bg-current transition-all duration-300 ${menuOpen ? 'scale-x-0 opacity-0' : ''}`} />
      ...
      >
        ...
        {/* Social icons */}
        <div className="flex shrink-0 flex-wrap items-center gap-5 px-8 pb-6">
          {[
